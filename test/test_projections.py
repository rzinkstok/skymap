...
class TestAzimuthalEquidistantProjection(unittest.TestCase):
    def setUp(self):
        ...
        self.p = AzimuthalEquidistantProjection(
            reference_longitude=0, reference_scale=40
        )
    ...
    def test_south_pole(self):
        self.p = AzimuthalEquidistantProjection(
            reference_longitude=0, reference_scale=40, north=False
        )
    ...
    def test_other_scale(self):
        self.p = AzimuthalEquidistantProjection(
            reference_longitude=0, reference_scale=80.0 / 190.0
        )
